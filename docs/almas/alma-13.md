...
| **Módulo código** | [`centro/missions/alma-13/`](../../centro/missions/alma-13/) |
...
Fase final do protocolo.

---

## O que vamos trabalhar

- [ ] Definir passos de missão em `centro/missions/alma-13/index.js` (`missions[]`)
- [ ] Implementar `onActivate` / `onResync` / `isComplete()`
- [ ] Missão Permanência / encerramento ARG.
