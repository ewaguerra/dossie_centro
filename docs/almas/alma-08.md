...
| **ID** | `alma-08` |
| **Kicker** | Oitava Alma |
| **Módulo código** | [`centro/missions/alma-08/`](../../centro/missions/alma-08/) |
...
- `02a_subsetores_arco_tamanduatei__polygon`
...
Camada `02a_subsetores_arco_tamanduatei__polygon`.

---

## O que vamos trabalhar

- [ ] Definir passos de missão em `centro/missions/alma-08/index.js` (`missions[]`)
- [ ] Implementar `onActivate` / `onResync` / `isComplete()`
- [ ] Missão setores interditos.
