...
| 7 | Map infra | `map-safe`, `layer-data-url`, `catalog-layer-controller`, `symbol-popup-layer`, **`poi-bootstrap`** |
...
| Triângulo Histórico | `syncTrianguloHistoricoOverlay()` / `removeTrianguloHistoricoOverlay()` |
